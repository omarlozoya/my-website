...
app.get("/resume", (req, res) => {
  ...
  res.setHeader(
    "Content-Disposition",
    "attachment; filename=Omar J Lozoya Resume.pdf"
  );
  file.pipe(res);
});
